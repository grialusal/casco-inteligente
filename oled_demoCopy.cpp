...
void drawFF (void) {
  ...
  display.clearDisplay();
  display.fillRect(display.width()/2-8,25,16,64,WHITE);
...
void drawFA (void) {
  ...
  display.clearDisplay();
  display.fillRect(display.width()/2-8,5,16,40,WHITE);
  display.fillTriangle(display.width()/2,hTercio*2+20,display.width()/2-17,hTercio*2,display.width()/2+17,hTercio*2,WHITE);
  display.display();
  sleep(2);
  display.clearDisplay();
}
